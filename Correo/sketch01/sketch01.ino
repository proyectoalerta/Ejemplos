...
const String GMAIL_USER_NAME = "alerta.proyecto@gmail.com";

// your Gmail password
const String GMAIL_PASSWORD = "jesussoto";

// the email address you want to send the email to, eg "jane.doe@temboo.com"
const String TO_EMAIL_ADDRESS = "marioniegar@gmail.com";
...
void loop()
{
  ...
  if (!success) {
    ...
    // then a subject line
    SendEmailChoreo.addInput("Subject", "ALERTA: Macagon tos vosotros ! me ha costao !");

     // next comes the message body, the main content of the email   
    SendEmailChoreo.addInput("MessageBody", "Ala, nos vemos!");
